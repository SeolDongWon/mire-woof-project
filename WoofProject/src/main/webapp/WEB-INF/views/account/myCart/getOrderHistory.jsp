	...
	<div class="col m-3">
		<div class="card">
			<div class="card-body">
				...
				<p class="card-text">
					<spring:message code="orderHistory.orderHistoryNo" /> : ${orderHistory.orderHistoryNo}
				</p>
				<p class="card-text">
					<spring:message code="orderHistory.totalPrice" /> : ₩${orderHistory.totalPrice}
				</p>
				<p class="card-text">
					<spring:message code="orderHistory.deliveryAddress" /> : ${orderHistory.address}
				</p>
			</div>
		</div>
	</div>
