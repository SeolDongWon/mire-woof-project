...
<menu class="dropdown mb-5 p-0">
    <ul class="nav nav-justified justify-content-around">
      ...
      <li class="navMenu nav-item rounded nav-underline ">
        <a href="" class="menu nav-link text-black fs-4 fw-light border-bottom" data-bs-toggle="dropdown" aria-expanded="false">고객센터</a>
        <menu class=" dropdown-menu w-100 m-0 p-0 border-0" id="serviceMenu">
          <ul class=" nav nav-underline nav-justified justify-content-around border-bottom "
          style="position:relative;top: -2px;">
            <li class="menu navMenu nav-item"><a href="/service/getFAQList" class="nav-link text-black">자주묻는 질문</a></li>
            <li class="menu navMenu nav-item"><a href="/service/getServiceList" class="nav-link text-black">문의사항</a></li>
          </ul>
        </menu>
        </menu>
      </li>
